...
import 'package:fcm_notifications_example/common_widgets/led_light.dart';
import 'package:fcm_notifications_example/common_widgets/remarkble_text.dart';
import 'package:fcm_notifications_example/common_widgets/service_control_panel.dart';
import 'package:fcm_notifications_example/common_widgets/shadow_top.dart';
import 'package:fcm_notifications_example/common_widgets/simple_button.dart';
import 'package:fcm_notifications_example/common_widgets/text_divisor.dart';
import 'package:fcm_notifications_example/common_widgets/text_note.dart';
import 'package:fcm_notifications_example/notifications/notification_controller.dart';
import 'package:fcm_notifications_example/routes.dart';
import 'package:fcm_notifications_example/utils/common_functions.dart';

import 'package:fcm_notifications_example/notifications/notification_utils.dart';
...
class _HomePageState extends State<HomePage> {
  String packageName = 'com.khohatsi.fcm_notifications_example';
  ...
  Future<void> getFirebaseMessagingToken() async {
    if (await FcmNotifications().isFirebaseAvailable) {
      ...
      try {
        await FcmNotifications().requestFirebaseAppToken();
      }
      catch (exception){
